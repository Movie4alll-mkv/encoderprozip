...
try:
    ...
    BOT_TOKEN = config("BOT_TOKEN","5271146077:AAFw5ZZK731UISWBTCBPDZPeDEVumtO-iFU")
    DEV = 1664850827
    ...
    THUMBNAIL = config("THUMBNAIL", default="https://te.legra.ph/file/ff5617db3309409eead53.jpg")
